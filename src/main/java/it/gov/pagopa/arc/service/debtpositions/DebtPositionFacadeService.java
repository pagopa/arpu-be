...
public interface DebtPositionFacadeService {
  ...
  DebtPositionExtendedDTO getDebtPositionDetail(Long brokerId, Long debtPositionId, String fiscalCode, IamUserInfoDTO loggedUser);
  FileResourceDTO getPaymentNotice(String fiscalCode, Long brokerId, Long organizationId, String nav, IamUserInfoDTO loggedUser);
