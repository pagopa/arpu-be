...
public interface DebtPositionTypeOrgFacadeService {
    ...
    List<DebtPositionTypeOrgsWithSpontaneousDTO> getMostUsedSpontaneousDebtPositionTypeOrgsForCurrentYear(Long brokerId, Long organizationId);
}
