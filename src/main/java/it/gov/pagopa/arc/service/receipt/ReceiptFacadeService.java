...
public interface ReceiptFacadeService {
    ...
    List<DebtorReceiptDTO> getDebtorReceipts(String debtorFiscalCode, Long brokerId, Long organizationId, Long debtPositionId, Long paymentOptionId, IamUserInfoDTO loggedUser);
}
