...
import it.gov.pagopa.arc.performancelogger.RestInvokePerformanceLogger;
import it.gov.pagopa.arc.utils.HttpUtils;
...
public class RestTemplateConfig {
  ...
  @Bean
  @ConfigurationProperties(prefix = "rest-client.defaults")
