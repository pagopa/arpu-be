...
class DebtPositionControllerImplTest {
    ...
    void whenGetPaymentNoticeThenOk() {
        ...
        Mockito.when(debtPositionFacadeServiceMock.getPaymentNotice(fiscalCode,brokerId,organizationId,installmentId,nav,iud,loggedUser))
                .thenReturn(resource);

        ResponseEntity<Resource> response = debtPositionController.getPaymentNotice(brokerId,organizationId,fiscalCode,nav,installmentId,iud);
    ...
    void whenGetPublicPaymentNoticeThenOk() {
        ...
        ResponseEntity<Resource> response = debtPositionController.getPublicPaymentNotice(fiscalCode,brokerId,organizationId,nav,installmentId,iud);
